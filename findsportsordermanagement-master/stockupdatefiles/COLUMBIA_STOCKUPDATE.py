...
dict_supplier_dashboard=dict(r.json()['Suppliers'][0]['Columbia'])
...
while(error_found==True and max_retries<5):
  try:
    ...
    print(e)
    print('clicking advanced button on page')

    driver.find_element_by_id('details-button').click()
    time.sleep(1);
    print('clicking proceed link')
    driver.find_element_by_id('proceed-link').click()
    error_found=True
    max_retries+=1
    print("Retrying",max_retries)
