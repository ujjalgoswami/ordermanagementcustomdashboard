...
input_file_name='whiteroom_stock_update.json'
output_file_name='whiteroom.csv'
...
list_of_SKU=[""]*max_count
list_of_Part_No=[""]*max_count
list_of_Active=[""]*max_count
list_of_Approved=[""]*max_count
list_of_Qty=[""]*max_count
list_of_Brand=[""]*max_count
list_of_Name=[""]*max_count
list_of_Description=[""]*max_count
list_of_Cost_Price=[""]*max_count
list_of_Price_A=[""]*max_count
list_of_Promotion=[""]*max_count
list_of_RRP=[""]*max_count
list_of_Image_Url=[""]*max_count
list_of_Image_Url_2=[""]*max_count
list_of_Image_Url_3=[""]*max_count
list_of_Image_Url_4=[""]*max_count
list_of_Image_Url_5=[""]*max_count
list_of_Image_Url_6=[""]*max_count
list_of_Image_Url_7=[""]*max_count
list_of_Image_Url_8=[""]*max_count
list_of_Image_Url_9=[""]*max_count
list_of_Image_Url_10=[""]*max_count
list_of_Parent_Product_SKU=[""]*max_count
list_of_Specifics=[""]*max_count
list_of_Primary_Supplier=[""]*max_count
list_of_Parent_Category=[""]*max_count
list_of_Weight=[""]*max_count
list_of_Width=[""]*max_count
list_of_Length=[""]*max_count
list_of_Height=[""]*max_count
list_of_Cubic=[""]*max_count
list_of_Google_Shipping_Column=[""]*max_count
Supplier_Name=[""]*max_count
list_of_Product_Category=[""]*max_count
list_of_Generate_URL_Automatically=[""]*max_count
list_of_UPC=[""]*max_count
list_of_Kogan_Category=[""]*max_count
list_of_Kogan_Department=[""]*max_count
...
for index in range(0,len(json_entries)):
    ...
    #                             print(style_number)
                            ...
                            if(single_size['_id'] in dict_item_properties):
                                dict_item_properties[single_size['_id']]['sku']=single_size['upc']
                                dict_item_properties[single_size['_id']]['upc']=single_size['upc']
...
if not(error_found):
    ...
    list_of_qty_sku_dict=api_product_response({'PrimarySupplier':'The_Whiteroom','IsActive':'True'},['AvailableSellQuantity','SKU','IsActive'],None)['Item']
